...
// NewManualTicketStore creates a new instance of ManualTicketStore. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
