...
// NewUserStore creates a new instance of UserStore. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewUserStore(t testing.TB) *UserStore {
	mock := &UserStore{}
	mock.Mock.Test(t)
