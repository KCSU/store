...
// NewRoleStore creates a new instance of RoleStore. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewRoleStore(t testing.TB) *RoleStore {
	mock := &RoleStore{}
	mock.Mock.Test(t)
