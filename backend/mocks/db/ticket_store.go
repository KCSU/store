...
// NewTicketStore creates a new instance of TicketStore. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewTicketStore(t testing.TB) *TicketStore {
	mock := &TicketStore{}
	mock.Mock.Test(t)
