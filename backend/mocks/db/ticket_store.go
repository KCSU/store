...
func (_m *TicketStore) Find(id uuid.UUID) (model.Ticket, error) {
	...
	var r0 model.Ticket
	var r1 error
	if rf, ok := ret.Get(0).(func(uuid.UUID) (model.Ticket, error)); ok {
		return rf(id)
	}
...
// Scan provides a mock function with given fields: id
func (_m *TicketStore) Scan(id uuid.UUID) error {
	ret := _m.Called(id)
