...
func (_m *FormalStore) Find(id uuid.UUID) (model.Formal, error) {
	...
	var r0 model.Formal
	var r1 error
	if rf, ok := ret.Get(0).(func(uuid.UUID) (model.Formal, error)); ok {
		return rf(id)
	}
...
func (_m *FormalStore) FindGuestList(id uuid.UUID) ([]model.FormalGuest, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(uuid.UUID) ([]model.FormalGuest, error)); ok {
		return rf(id)
	}
...
func (_m *FormalStore) GetGroups(ids []uuid.UUID) ([]model.Group, error) {
	...
	var r0 []model.Group
	var r1 error
	if rf, ok := ret.Get(0).(func([]uuid.UUID) ([]model.Group, error)); ok {
		return rf(ids)
	}
...
// GetQueueLength provides a mock function with given fields: id
func (_m *FormalStore) GetQueueLength(id uuid.UUID) (int, error) {
	ret := _m.Called(id)
...
// GetTicketStats provides a mock function with given fields: id, isGuest
func (_m *FormalStore) GetTicketStats(id uuid.UUID, isGuest bool) ([]model.TicketStat, error) {
	ret := _m.Called(id, isGuest)

	var r0 []model.TicketStat
	var r1 error
	if rf, ok := ret.Get(0).(func(uuid.UUID, bool) ([]model.TicketStat, error)); ok {
		return rf(id, isGuest)
	}
	if rf, ok := ret.Get(0).(func(uuid.UUID, bool) []model.TicketStat); ok {
		r0 = rf(id, isGuest)
	} else {
		if ret.Get(0) != nil {
...
type mockConstructorTestingTNewFormalStore interface {
	mock.TestingT
	Cleanup(func())
}

// NewFormalStore creates a new instance of FormalStore. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewFormalStore(t mockConstructorTestingTNewFormalStore) *FormalStore {
	mock := &FormalStore{}
	mock.Mock.Test(t)
