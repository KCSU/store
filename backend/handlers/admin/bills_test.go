		...
		"formals": [
			{
				...
				"guestLimit": 2,
				"firstSaleTickets": 10,
				"firstSaleGuestTickets": 5,
				"firstSaleStart": "2022-04-23T14:00:00+01:00",
				"secondSaleTickets": 20,
				"secondSaleGuestTickets": 7,
				"secondSaleStart": "2022-04-24T14:00:00+01:00",
		...
		Formals: []model.Formal{
			{
				...
				FirstSaleTickets:       10,
				FirstSaleGuestTickets:  5,
				FirstSaleStart:         time.Date(2022, 4, 23, 14, 0, 0, 0, time.FixedZone("Europe/London", 3600)),
				SecondSaleTickets:      20,
				SecondSaleGuestTickets: 7,
				SecondSaleStart:        time.Date(2022, 4, 24, 14, 0, 0, 0, time.FixedZone("Europe/London", 3600)),
